<template lang="html">
    <div class="">
        ...
        <b-table
            ...
            @filtered="onFiltered"
        >
                <template slot="before" slot-scope="data">
                    <img :src="data.item.before.thumb" alt="" width="64">
                </template>
                ...
                <template slot="after" slot-scope="data">
                    <img :src="data.item.after.thumb" alt="" width="64">
                </template>
        ...
        <b-modal
            ...
            ref="modal">
                <div class="form-group">
                    ...
                    <b-form-select v-model="selectedCat" :options="selectedOpts" />
                </div>
                <div class="form-group">
                    <label for="title">Prima</label>
                    <b-form-file v-model="file_before" :state="Boolean(file_before)" placeholder="Scegli un'immagine..."></b-form-file>
                </div>
                <div class="form-group">
                    <label for="title">Dopo</label>
                    <b-form-file v-model="file_after" :state="Boolean(file_after)" placeholder="Scegli un'immagine..."></b-form-file>
                </div>
                <div slot="modal-footer">
                    <b-btn variant="link">Annulla</b-btn>
...
export default {
    ...
    data: function() {
        return {
            ...
            selectedCat: null,
            selectedOpts: [
                { value: null, text: 'Selezione una categoria...' },
                { value: 1, text: 'Medicina Estetica' },
                { value: 2, text: 'Odontoiatria' }
            ]
        }
    },
    methods: {
