<template lang="html">
    <div class="about">
        ...
        <div id="about-studio">
            <div class="about-container d-flex flex-column justify-content-center align-items-center">
                <div class="studio-gallery__action">
                    <button class="btn btn-purple"><span>foto studio </span><icon-arrow-down  width="16px" ref="contactIcon"/></button>
                </div>
                <div class="studio-gallery__gallery">
                    <gallery-container
                        background="white"
                        ref="galleryEstetica"
                        :items="esteticaArr"/>
